...
/**start图层树**/
    ...
    function zTree_LayesTree(layerInfos){
      ...
      function zTreeBuilder(ztree_LayerInfos){
        ...
        var nodesIconsUrl = ztree_LayerInfos.url+"/legend?f=pjson";
        var nodesIconsJ;
        script.get(nodesIconsUrl,{
            jsonp: 'callback',
        ...
        for(i=0;i<nodes.length;i++){
          ...
          var ztree_nodeId = nodes[i].id;
          var nodeIcon = "data:"+nodesIconsJ[ztree_nodeId].legend[0].contentType+";base64,"+nodesIconsJ[ztree_nodeId].legend[0].imageData;
          //如果是管点不是管段
